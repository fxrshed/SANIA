...
models_dict = {
    ...
    "ShuffleNetV2x0_5": models.shufflenet_v2_x0_5,
}
...
if __name__ == "__main__":
    ...
    main(model_name="ShuffleNetV2x0_5", dataset_name="SVHN", optimizer_name=args.optimizer, lr=args.lr, eps=args.eps, n_epochs=args.n_epochs, 
